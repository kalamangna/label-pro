...
- **Smart Duplicate Check**: Deteksi otomatis data tamu yang identik atau mirip menggunakan algoritma fuzzy matching tingkat lanjut. Sistem memvalidasi kesamaan Nama (60%), Jabatan (15%), dan Alamat (25%) dengan normalisasi otomatis terhadap variasi penulisan nama (contoh: Muhammad vs Muh.) dan deteksi nama yang terbalik (contoh: Ahmad Fauzi vs Fauzi Ahmad).
