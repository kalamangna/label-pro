...
<head>
    ...
    <title>LabelPro - Cetak Label Undangan 103 & 121 Otomatis</title>
...
<body class="bg-white text-gray-900 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center">
                    <span class="text-2xl font-extrabold text-emerald-600 tracking-tight">LabelPro</span>
                </div>
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="/dashboard" class="text-sm font-bold text-emerald-600 border-2 border-emerald-600 px-4 py-2 rounded-lg hover:bg-emerald-600 hover:text-white transition-all">Coba Demo</a>
                    <a href="https://wa.me/YOUR_NUMBER" class="bg-amber-500 text-white px-5 py-2.5 rounded-lg text-sm font-bold hover:bg-amber-600 transition-all shadow-lg shadow-amber-200">Beli Sekarang</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="text-center lg:text-left grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h1 class="text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900 leading-tight mb-6">
                        Cetak Label Undangan <span class="text-emerald-600">Dalam Hitungan Detik</span>, Bukan Jam!
                    </h1>
                    <p class="text-xl text-gray-600 mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
                        Stop ngetik manual di Word. Impor dari Excel, pilih ukuran label (103/121), dan cetak label yang presisi secara instan.
                    </p>
                    <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                        <a href="https://wa.me/YOUR_NUMBER" class="bg-amber-500 text-white px-8 py-4 rounded-xl text-lg font-bold hover:bg-amber-600 transition-all shadow-xl shadow-amber-200 flex items-center justify-center">
                            Dapatkan Akses Seumur Hidup
                            <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                        </a>
                        <a href="/dashboard" class="bg-white text-gray-700 border-2 border-gray-200 px-8 py-4 rounded-xl text-lg font-bold hover:border-emerald-600 hover:text-emerald-600 transition-all flex items-center justify-center">
                            Lihat Demo Live
                        </a>
                    </div>
                    ...
                    <ul class="space-y-6">
                        <li class="flex items-start">
                            <div class="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mt-1">
                                <svg class="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"></path></svg>
                            </div>
                            <div class="ml-4">
                ...
                <div class="p-10 text-center">
                    ...
                    <ul class="text-left space-y-4 mb-10">
                        <li class="flex items-center text-sm">
                            <svg class="w-5 h-5 text-emerald-500 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"></path></svg>
                    ...
                    <a href="https://wa.me/YOUR_NUMBER?text=Halo! Saya ingin membeli LabelPro untuk mempermudah pekerjaan saya." class="block bg-amber-500 text-white py-4 rounded-xl text-lg font-bold hover:bg-amber-600 transition-all shadow-xl shadow-amber-100">
    ...
    <footer class="py-12 bg-gray-50 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <span class="text-xl font-extrabold text-emerald-600 tracking-tight">LabelPro</span>
            <p class="mt-4 text-gray-500 text-sm">
                &copy; 2026 LabelPro. Dibuat dengan ❤️ untuk memudahkan pekerjaan Anda.
            </p>
        </div>
    </footer>
